            ...
            <form noValidate onSubmit={handleSubmit}>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={6}>
                  <FormControl
                    fullWidth
                    error={Boolean(touched.context_length && errors.context_length)}
                ...
                <Grid item xs={12}>
                  <FormControl fullWidth sx={{ ...theme.typography.otherInput }}>
                    <Autocomplete
                          ...
                          return (
                            <Chip
                              ...
                              sx={{
                                ...
                                mr: 0.5,
                                backgroundColor:
                                  color === 'default' ? alpha(theme.palette.grey[500], 0.16) : alpha(theme.palette[color].main, 0.16),
                                color: color === 'default' ? theme.palette.text.secondary : theme.palette[color].dark,
                                '& .MuiChip-deleteIcon': {
                                  color: color === 'default' ? theme.palette.text.secondary : theme.palette[color].dark,
                                  '&:hover': {
                      ...
                      renderInput={(params) => <TextField {...params} label="輸入模態" placeholder="選擇或輸入" />}
                ...
                <Grid item xs={12}>
                  <FormControl fullWidth sx={{ ...theme.typography.otherInput }}>
                    <Autocomplete
                      ...
                      renderInput={(params) => <TextField {...params} label="輸出模態" placeholder="選擇或輸入" />}
                      renderOption={(props, option) => {
                        const color = MODALITY_OPTIONS[option]?.color || 'default';
                        const { key, ...otherProps } = props;
                        return (
                ...
                <Grid item xs={12}>
                  <FormControl fullWidth sx={{ ...theme.typography.otherInput }}>
                    <Autocomplete
                      ...
                      renderInput={(params) => <TextField {...params} label="標籤" placeholder="輸入標籤，Enter鍵確認" />}
                    />
                  </FormControl>
                </Grid>
              </Grid>
